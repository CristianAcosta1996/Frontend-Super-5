        ...
        <Grid container justifyContent={"center"}>
          ...
          >
            ...
            <Typography
              ...
              color="#ff0056"
              my={1}
              sx={{ display: "flex", marginTop: 0, marginBottom: 0, marginLeft: 0 }}
            >
              ${producto.precio}
            </Typography>
          </CardContent>
        ...
        >
          ...
          <div style={{ display: "flex" }}>
            <Typography
              ...
              color="#8f8f8f"
              my={1}
              sx={{ textDecoration: 'line-through', marginTop: 0, marginBottom: 0, marginLeft: 0 }}
            >
              ${producto.precio}
            </Typography>
            <Typography
              ...
              color="#ff0056"
              my={1}
              sx={{ paddingLeft: 1, marginTop: 0, marginBottom: 0, marginLeft: 0 }}
            >
