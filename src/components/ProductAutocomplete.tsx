...
import { useGetCategoriasQuery, useLazyGetProductosPorSucursalQuery } from '../store/super5/super5Api';
...
export default function ProductAutocomplete() {
    ...
    return (
        <Autocomplete
            ...
            id="combo-box-demo"
            options={productos ? productos?.map(({ descripcion, precio, categoriaId }) => {
                const nombreCategoria = getNombreCategoria(categoriaId)
                return { label: `${descripcion + " $" + precio}`, nombreCategoria }
